...
export default function ToolsDashboard() {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white">
      <Helmet>
        <title>Sales Dashboard | E-commerce Analytics for Business Growth</title>
        <meta
          name="description"
          content="Boost your e-commerce business with our sales dashboard. Analyze sales, pricing, and customer trends for Shopify ecommerce and digital marketing success. Perfect for entrepreneurs and marketing agencies."
        />
        <meta
          name="keywords"
          content="e commerce, business, sales, pricing, seo, website, campaigns, advertising, digital marketing agency, marketing agency, entrepreneur, shopify ecommerce, search engine marketing, digital ads, web page design"
        />
      </Helmet>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-purple-600 py-20 animate-gradient-x">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h1 className="text-5xl md:text-6xl font-extrabold text-center tracking-tight">
            Your E-commerce <span className="text-yellow-300">Sales Dashboard</span>
          </h1>
          <p className="mt-6 text-xl text-gray-100 text-center max-w-3xl mx-auto">
            Power your business with sales analytics and insights for campaigns, pricing, and growth.
          </p>
