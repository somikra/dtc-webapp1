...
import {
  DollarSign, LogOut, BarChart2, TrendingUp, Search, Mail, X,
} from 'lucide-react';
      ...
      <header className="bg-gradient-to-r from-orange-500 to-purple-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-5xl md:text-6xl font-bold text-center text-white">
            Pricing Optimizer for <span className="text-yellow-300">DTC Success</span> <DollarSign className="inline h-8 w-8" />
          </h1>
          <p className="mt-6 text-xl text-gray-100 text-center max-w-3xl mx-auto">
            Maximize profits with smart pricing strategies tailored for your e-commerce empire.
          </p>
        </div>
      </header>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="w-full">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
                ...
                <a href="/pricing-optimizer" className="group relative px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 rounded-xl font-semibold text-sm flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 hover:ring-2 hover:ring-yellow-300">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Pricing Optimizer <span className="text-yellow-300">Coming Soon</span>
          </h2>
          ...
          <p className="text-xl text-gray-300 mb-6 max-w-2xl mx-auto">
            We’re forging a pricing tool to boost your DTC profits! Stay tuned for an optimizer that’ll fine-tune your strategy and dominate the market.
          </p>
